...
def render_methodology_page(
    ...
    pin_keys_with_doc = [
        ...
        ("schemas_hash", "Hash of every JSON schema in publish/api/schemas/."),
        ("prompts_hash", "Hash of every prompt in core/analyze/prompts/."),
        ("canonical_stories_hash", "Hash of canonical_stories.json (legacy v9 — unused in v10)."),
